...
function App() {
  ...
  const titleInputRef = useRef(null); // Ref for title input
  ...
  const handleEditTask = (task) => {
    ...
    titleInputRef.current.focus(); // Focus on title input
  };
      ...
      <main>
        {!user ? (
          ...
          <>
            ...
            />
            <button className="register-btn" onClick={handleCreateTask}>
              Add Task
            </button>
            ...
            <div className="tasks-container">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  className="task-card"
                  style={{ backgroundColor: task.completed ? "#e6ffe6" : "#fff" }}
                >
